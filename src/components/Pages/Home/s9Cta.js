...
const S9Cta = () => (
    <>
  {/* Section 9 */}
  <section className="relative py-24 bg-white bg-bottom bg-cover" style={{backgroundImage: 'url("https://cdn.devdojo.com/images/december2020/cta-bg.jpeg")'}}>
    ...
    <div className="flex flex-col items-center justify-between px-10 mx-auto max-w-7xl xl:px-12 lg:flex-row">
      ...
      <a href="#_" className="relative flex-shrink-0 px-10 py-5 text-xl font-medium text-center text-white bg-green-700 rounded-lg lg:text-2xl focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 focus:outline-none">Sign Up Today</a>
    </div>
  </section>
