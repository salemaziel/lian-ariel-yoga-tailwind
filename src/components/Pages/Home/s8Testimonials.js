  ...
  <section className="flex items-center justify-center py-20 bg-white min-w-screen">
    <div className="px-16 bg-white">
      <div className="container flex flex-col items-start mx-auto lg:items-center">
        ...
        <h2 className="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold text-gray-600 lg:justify-center">
        ...
        <div className="block w-full h-0.5 max-w-lg mt-6 bg-green-50 rounded-full" />
