	...
	return (
				...
				<div
					className={
						(scroll
							...
							: ' bg-transparent ') +
						' flex items-center w-full h-auto md:pt-8 fixed z-30'
					}
				>
        ...
        leaveTo="opacity-0"
			>*/}
				...
				>
					<Menu.Items
						className="fixed top-0 z-20 flex flex-col items-center justify-center w-full h-full space-y-5 text-lg transition duration-300 ease-in-out origin-center bg-green-700"
						/*style={{ display: 'none' }}*/
					>
						<Menu.Item>
							{({ active }) => (
